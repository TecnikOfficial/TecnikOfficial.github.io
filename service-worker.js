...
.video-background::before {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(0, 0, 0, 0.4); /* Dark overlay with reduced opacity (30%) */
...
<div id="loading-screen">
    ...
    <div class="video-background">
        <video autoplay muted loop>
            <source src="https://tecnik.pages.dev/assets/media/video.mp4" type="video/mp4"><!-- Video Credit: Pexels.com -->
...
<div id="donation-overlay" class="overlay">
    <div class="overlay-content">
        ...
        <h2 style="color: green; text-align: center; text-decoration: underline;">Choose Payment Method to Support</h2>
		<br>
        <div class="button-container">
...
<div id="projects-overlay" class="overlay">
    ...
    <div id="notification-panel">
        <div class="overlay-content">
            <p>1: Are you subscribed to ▶️<a href="https://www.youtube.com/channel/UCXucwi4swKyTmCUB9RrFaQw?sub_confirmation=1" target="_blank">Tecnik Official</a>💻 ?</p><br>
<p>2: Are you subscribed to ▶️<a href="https://www.youtube.com/channel/UC35TPNUnNegZq4mBWvU0o7g?sub_confirmation=1" target="_blank">Syncking</a>🎵 ?</p><br>
...
<p>4: <a href="./oldtheme/1.0.html">Old Site 🐈</a></p>
    ...
    <a href="https://github.com/TecnikOfficial/TecnikOfficial.github.io" target="_blank">
        <img src="https://www.svgrepo.com/show/512317/github-142.svg" alt="GitHub" title="Github" width="20" height="20" style="vertical-align: bottom;"></a>
</footer>
    <script>// Array of text options
const textOptions = [
    "COMPUTER ENTHUSIAST",
    "‏‏‎WINDOWS & ANDROID TWEAKER‏‏‎‏‏‎",
    "‎‏‏‎‎A.i EXPLORER‎‏‏‎ CASUAL GAMER",
...
function handleDonation(url) {
    ...
    if (window.innerWidth < 768) {
        messageElement.style.width = '90%'; // Set width to 90% for mobile
    } else {
        messageElement.style.width = '400px'; // Set a fixed width for larger screens
    }
